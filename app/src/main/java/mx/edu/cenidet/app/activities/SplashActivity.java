...
public class SplashActivity extends AppCompatActivity implements DeviceTokenControllerSdk.DeviceTokenServiceMethods, ZoneControllerSdk.ZoneServiceMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fcmToken = appPreferences.getPreferenceString(getApplicationContext(),ConstantSdk.STATIC_PREFERENCES, ConstantSdk.PREFERENCE_KEY_FCMTOKEN);Log.d("TOKEN", fcmToken);
