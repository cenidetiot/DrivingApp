        ...
        switch (severity){
            case "informational":
                notificationBuilder = new NotificationCompat.Builder(this)
                        ...
                        .setAutoCancel(true)
                        .setColorized(true)
                        .setColor(getColor(R.color.bg_screen1))
            ...
            case "low":
                notificationBuilder = new NotificationCompat.Builder(this)
                        ...
                        .setAutoCancel(true)
                        .setColorized(true)
                        .setColor(getColor(R.color.bg_screen2))
                        .setSmallIcon(R.drawable.ic_car)
                        .setVibrate(new long[] {100, 250, 100, 500})
                        .setSound(defaultSoundUri)
                        .setContentIntent(pendingIntent);
            ...
            case "medium":
                notificationBuilder = new NotificationCompat.Builder(this)
                        ...
                        .setAutoCancel(true)
                        .setColorized(true)
                        .setColor(getColor(R.color.bg_screen3))
                        .setSmallIcon(R.drawable.ic_car)
                        .setVibrate(new long[] {100, 250, 100, 500})
                        .setSound(defaultSoundUri)
                        .setContentIntent(pendingIntent);
            ...
            case "high":
                notificationBuilder = new NotificationCompat.Builder(this)
                        ...
                        .setAutoCancel(true)
                        .setColorized(true)
                        .setColor(getColor(R.color.bg_screen4))
                        .setSmallIcon(R.drawable.ic_car)
                        .setVibrate(new long[] {100, 250, 100, 500})
                        .setSound(defaultSoundUri)
                        .setContentIntent(pendingIntent);
            ...
            case "critical":
                notificationBuilder = new NotificationCompat.Builder(this)
                        ...
                        .setAutoCancel(true)
                        .setColorized(true)
                        .setColor(getColor(R.color.bg_screen5))
                        .setSmallIcon(R.drawable.ic_car)
                        .setVibrate(new long[] {100, 250, 100, 500})
                        .setSound(defaultSoundUri)
                        .setContentIntent(pendingIntent);
